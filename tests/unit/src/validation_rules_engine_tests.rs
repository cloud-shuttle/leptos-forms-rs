        ...
        vec![
            ...
            leptos_forms_rs::core::FieldMetadata {
                ...
                validators: vec![
                    ...
                    leptos_forms_rs::validation::Validator::Pattern(r"^[a-zA-Z0-9!@#$%^&*()_+\-=\[\]{}|;:,.<>?]{8,}$".to_string()),
            ...
            leptos_forms_rs::core::FieldMetadata {
                name: "age".to_string(),
                field_type: leptos_forms_rs::core::types::FieldType::Number(leptos_forms_rs::core::types::NumberType {
                    min: Some(0.0),
                    max: Some(120.0),
                    step: Some(1.0),
                }),
            ...
            leptos_forms_rs::core::FieldMetadata {
                ...
                is_required: false,
                validators: vec![
                    leptos_forms_rs::validation::Validator::Pattern(r"^\+?[\d\s\-\(\)]+$".to_string()),
                ],
                ..Default::default()
            },
            leptos_forms_rs::core::FieldMetadata {
                ...
                is_required: false,
                validators: vec![
                    leptos_forms_rs::validation::Validator::Pattern(r"^\d{5}(-\d{4})?$".to_string()),
                ],
                ..Default::default()
            },
            leptos_forms_rs::core::FieldMetadata {
                ...
                is_required: false,
                validators: vec![
                    leptos_forms_rs::validation::Validator::Custom("luhn_algorithm".to_string()),
                ],
                ..Default::default()
            },
            leptos_forms_rs::core::FieldMetadata {
                ...
                is_required: false,
                validators: vec![
                    leptos_forms_rs::validation::Validator::Custom("unique_value".to_string()),
                ],
                ..Default::default()
            },
        ]
...
fn test_validation_rules_engine_creation() {
    let form: FormHandle<ValidationRulesForm> = FormHandle::new(ValidationRulesForm::default_values());
...
fn test_validation_rules_metadata() {
    ...
    assert!(email_field.validators.contains(&leptos_forms_rs::validation::Validator::Email));
    
    let password_field = metadata.iter().find(|f| f.name == "password").unwrap();
    assert!(password_field.validators.len() >= 3);
    assert!(password_field.validators.contains(&leptos_forms_rs::validation::Validator::MinLength(8)));
}
