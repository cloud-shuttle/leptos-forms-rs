use leptos::prelude::*;
use leptos_forms_rs::core::{FieldMetadata, FieldType, FieldValue, Form, FormHandle, FormSchema};
...
impl Form for MultiStepTestForm {
    fn field_metadata() -> Vec<FieldMetadata> {
        ...
        metadata.push(FieldMetadata {
            ...
            validators: vec![
                Validator::Required,
                Validator::Pattern(r"^\d{10}$".to_string()),
            ],
        });
    ...
    fn validate(&self) -> Result<(), ValidationErrors> {
        ...
        if self.address.is_empty() {
            ...
            errors.add_field_error(
                "address",
                "Address must be at least 10 characters".to_string(),
            );
        }
...
mod tests {
    ...
    fn test_multi_step_form_field_values() {
        ...
        assert_eq!(
            form.get_field_value("first_name"),
        ...
        assert_eq!(
            form.get_field_value("newsletter"),
    ...
    fn test_multi_step_form_step_validation() {
        ...
        form_handle.set_field_value(
            "email",
            FieldValue::String("charlie@example.com".to_string()),
        );
